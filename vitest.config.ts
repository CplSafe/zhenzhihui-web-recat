  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'src/utils/seekableMediaSource.ts',
        'src/utils/smartDraft.ts',
        'src/utils/smartRealPerson.ts',
        'src/utils/studioModelPresentation.ts',
        'src/utils/studioParams.ts',
        'src/utils/studioRefVideo.ts',
        'src/utils/studioShots.ts',
        'src/utils/studioVideoMode.ts',
        'src/utils/subjectDuplicates.ts',
        'src/utils/timelineClips.ts',
