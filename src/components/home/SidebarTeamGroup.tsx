...
import { useCurrentMember, useCurrentUser, useCurrentWorkspace, useWorkspaceSessionStore } from '@/stores/workspaceSession'
...
export default function SidebarTeamGroup({ collapsed = false }: SidebarTeamGroupProps) {
  ...
  const currentRole = String(
    currentMember?.workspace_role || currentMember?.workspaceRole || currentMember?.member_role || currentMember?.memberRole || currentMember?.role || '',
  )
    .trim()
    .toLowerCase()
